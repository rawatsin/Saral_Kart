      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-sm font-bold uppercase tracking-wider text-slate-900 dark:text-white mb-5">Shop</h3>
              ...
              {[
                ...
                <li key={item.name}>
                  <Link 
                    ...
                    className="group inline-flex items-center text-slate-600 dark:text-slate-400 transition-colors hover:text-emerald-600 dark:hover:text-emerald-400"
                  >
          ...
          {/* Navigation - Company */}
          <div className="lg:col-span-2">
            <h3 className="text-sm font-bold uppercase tracking-wider text-slate-900 dark:text-white mb-5">Company</h3>
            <ul className="space-y-3.5 text-sm">
              {[
          ...
          <div className="space-y-5 lg:col-span-4">
            <div>
              <h3 className="text-sm font-bold uppercase tracking-wider text-slate-900 dark:text-white mb-2">Stay Updated</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Get notified about new collections and exclusive offers.
              </p>
            </div>
            <form className="flex w-full max-w-sm flex-col gap-2" onSubmit={(e) => e.preventDefault()}>
